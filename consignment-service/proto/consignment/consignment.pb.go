...
//Reference imports to suppress errors id they are not otherwise used.
...
//func NewShppingServiceClient(serviceName string, c client.Client) shippingServiceClient
func NewShppingServiceClient(serviceName string, c client.Client) *shippingServiceClient {
	if c == nil {
		c = client.NewClient()
	}
...
var fileDescriptor0 = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0x8c, 0x92, 0x4f, 0x4e, 0xeb, 0x30,
